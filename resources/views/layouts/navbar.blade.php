    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="fa fa-list"></span> Enquiries <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="/enquiries/create"><i class="fa fa-calendar-plus-o"></i> Add Enquiry</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="/notes/create"><i class="fa fa-calendar-plus-o"></i> Add Notes</a></li>
                        <li><a href="/notes"><i class="fa fa-edit"></i> View Notes</a></li>
                    </ul>
                </li>
            </ul>
